<template>
  <div class="border border-gray-300 dark:border-gray-600 rounded-lg">
    <div class="toolbar flex items-center gap-2 p-2 border-b border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded-t-lg">
      <button @click="execCmd('bold')" title="Fett" class="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600">
      ...
      <button @click="execCmd('italic')" title="Kursiv" class="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600">
      ...
      <button @click="execCmd('insertUnorderedList')" title="Liste" class="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600">
      ...
      <button @click="addLink" title="Link einfügen" class="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600">
