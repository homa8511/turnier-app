<template>
  <div class="border border-gray-300 dark:border-gray-600 rounded-lg">
    <div class="toolbar flex items-center gap-2 p-2 border-b border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded-t-lg">
      <button class="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600" title="Fett" @click="execCmd('bold')">
      ...
      <button class="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600" title="Kursiv" @click="execCmd('italic')">
      ...
      <button class="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600" title="Liste" @click="execCmd('insertUnorderedList')">
      ...
      <button class="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600" title="Link einfügen" @click="addLink">
