...
describe('Tournament API End-to-End Tests', () => {
    ...
    it('sollte einen kompletten Turnier-Lebenszyklus durchlaufen', async () => {
        ...
        tournamentId = createResponse.body.config.id;
        ...
        expect(startResponse.body.rounds.length).toBe(1);
        ...
        expect(getResponse.body.teams[0].played).toBe(1); // Jedes Team sollte 1 Spiel gespielt haben
    });
